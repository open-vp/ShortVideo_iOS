...
- (void)initUI {
    ...
    _txtRoomId = [[UITextField alloc] initWithFrame:CGRectMake(10, 15 + ICON_SIZE + 10, 70, ICON_SIZE)];
    ...
    _txtUserId = [[UITextField alloc] initWithFrame:CGRectMake(85, 15 + ICON_SIZE + 10, 120, ICON_SIZE)];
    ...
    _txtUserPwd = [[UITextField alloc] initWithFrame:CGRectMake(210, 15 + ICON_SIZE + 10, 120, ICON_SIZE)];
...
- (void)relayout {
    ...
    int rowNum = 2;
    int colNum = 2;
    CGRect videoRectScope = CGRectMake(0, 100*kScaleY, self.view.size.width, self.view.size.height - 150*kScaleY);
