...
- (IBAction)onClickLow:(id)sender {
    ...
    [self setBtn:_btnHigh selected:NO];
    [self setBtn:_btnCustom selected:NO];
    _videoConfig.bps = 1200;
    _videoConfig.fps = 20;
    _videoConfig.gop = 3;
    _textFieldKbps.text = [@(1200) stringValue];
    _textFieldFps.text = [@(20) stringValue];
    _textFieldDuration.text = [@(3) stringValue];
    [self setBtnEnable:NO];
    [self onClick360:nil];
}
...
- (IBAction)onClickMedium:(id)sender {
    ...
    _videoConfig.fps = 20;
    _videoConfig.gop = 3;
    _textFieldKbps.text = [@(2400) stringValue];
    _textFieldFps.text = [@(20) stringValue];
    _textFieldDuration.text = [@(3) stringValue];
}
...
- (IBAction)onClickHigh:(id)sender {
    ...
    [self setBtnEnable:NO];
    [self onclick720:nil];
    _videoConfig.bps = 3600;
    _videoConfig.fps = 20;
    _videoConfig.gop = 3;
    _textFieldKbps.text = [@(3600) stringValue];
    _textFieldFps.text = [@(20) stringValue];
    _textFieldDuration.text = [@(3) stringValue];
}
