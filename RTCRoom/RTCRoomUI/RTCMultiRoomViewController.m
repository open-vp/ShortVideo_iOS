...
@interface RTCMultiRoomViewController () {
    UIView                   *_pusherView;
...
@implementation RTCMultiRoomViewController
...
- (BOOL)navigationShouldPopOnBackButton {
    ...
    for (UIViewController *vc in self.navigationController.viewControllers) {
        if ([vc isKindOfClass:[RTCMultiRoomListViewController class]]) {
            targetVC = vc;
            break;
        }
    }
